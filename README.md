...
- [Install KubeSlice on cloud clusters](https://kubeslice.io/documentation/open-source/1.2.0/category/install-kubeslice).
- [Install KubeSlice on kind clusters using our Sandbox](https://kubeslice.io/documentation/open-source/1.2.0/playground/sandbox).
